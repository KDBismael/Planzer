<template>
    ...
    <div class="calendar-setting">
        <div class=" row justify-content-center w-100 title">
            <h1 class="w-auto mb-0 pb-4">Calendar Setup</h1>
        </div>
        <setting-navigation whereIs="calendarSetting"></setting-navigation>
        <div class="row justify-content-center">
            <div class="content">
                ...
                <div class="default-calendar mt-3 mb-3 p-3">
...
<script>
import calendarSwitchCheck from '../components/calendarSwitchCheck.vue'
import calendarSettingCard from '../components/calendarSettingCard.vue'
